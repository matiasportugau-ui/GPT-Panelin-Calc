...
// POST /api/pdf
// Accepts EITHER:
//   1. { cotizacion_id, cliente }   - looks up a quote generated by /api/cotizar
  ...
  try {
    ...
    if (req.body.cotizacion_data) {
      return res.status(400).json({
        ok: false,
        error: 'cotizacion_data no es aceptado. Genera el PDF con cotizacion_id o envia parametros de cotizacion para recalcular precios oficiales.',
      });
    }
